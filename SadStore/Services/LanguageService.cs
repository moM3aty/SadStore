    ...
    public class LanguageService
    {
        ...
        public LanguageService()
        {
            _resources = new Dictionary<string, Dictionary<string, string>>
            {
                ...
                { "We are here to help", new Dictionary<string, string> { { "ar", "نحن هنا لمساعدتك" }, { "en", "We are here to help" } } },
                { "Enter your name", new Dictionary<string, string> { { "ar", "ادخل اسمك" }, { "en", "Enter your name" } } },
                { "Message Type", new Dictionary<string, string> { { "ar", "نوع الرسالة" }, { "en", "Message Type" } } },
                { "Select Type", new Dictionary<string, string> { { "ar", "اختر النوع" }, { "en", "Select Type" } } },
                { "Inquiry", new Dictionary<string, string> { { "ar", "استفسار" }, { "en", "Inquiry" } } },
                { "Complaint", new Dictionary<string, string> { { "ar", "شكوي" }, { "en", "Complaint" } } },
                { "Suggestion", new Dictionary<string, string> { { "ar", "اقتراح" }, { "en", "Suggestion" } } },
                { "Message", new Dictionary<string, string> { { "ar", "الرسالة" }, { "en", "Message" } } },
                { "Send", new Dictionary<string, string> { { "ar", "إرسال" }, { "en", "Send" } } },
                { "Working Hours", new Dictionary<string, string> { { "ar", "ساعات العمل" }, { "en", "Working Hours" } } },
                { "Sunday to Thursday", new Dictionary<string, string> { { "ar", "الأحد إلى الخميس" }, { "en", "Sunday to Thursday" } } },
                { "9:00 AM - 9:00 PM", new Dictionary<string, string> { { "ar", "9:00 صباحاً - 9:00 مساءً" }, { "en", "9:00 AM - 9:00 PM" } } },
                { "Cotton", new Dictionary<string, string> { { "ar", "قطن" }, { "en", "Cotton" } } },
                { "Silk", new Dictionary<string, string> { { "ar", "حرير" }, { "en", "Silk" } } },
                { "Wool", new Dictionary<string, string> { { "ar", "صوف" }, { "en", "Wool" } } },
                { "Black Abayas", new Dictionary<string, string> { { "ar", "عبايات سوداء" }, { "en", "Black Abayas" } } },
                { "Colorful Abayas", new Dictionary<string, string> { { "ar", "عبايات ملونة" }, { "en", "Colorful Abayas" } } },
                { "Men", new Dictionary<string, string> { { "ar", "رجالي" }, { "en", "Men" } } },
                { "Women", new Dictionary<string, string> { { "ar", "حريمي" }, { "en", "Women" } } },
                { "Natural", new Dictionary<string, string> { { "ar", "طبيعي" }, { "en", "Natural" } } },
                { "Synthetic", new Dictionary<string, string> { { "ar", "صناعي" }, { "en", "Synthetic" } } },
                { "Gifts", new Dictionary<string, string> { { "ar", "هدايا" }, { "en", "Gifts" } } },
                { "Event Giveaways", new Dictionary<string, string> { { "ar", "توزيعات مناسبات" }, { "en", "Event Giveaways" } } },
