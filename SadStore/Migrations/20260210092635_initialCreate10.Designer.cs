...
namespace SadStore.Migrations
{
    ...
    [Migration("20260210092635_initialCreate10")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SadStore.Data.BlogPost", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SadStore.Data.CustomerReview", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SadStore.Data.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SadStore.Data.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SadStore.Data.OrderItem", b =>
                {
                    b.HasOne("SadStore.Data.Order", "Order")
                        .WithMany("OrderItems")
            ...
            modelBuilder.Entity("SadStore.Data.Product", b =>
                {
                    b.HasOne("SadStore.Data.Category", "Category")
                        .WithMany("Products")
